...
#[no_mangle]
pub extern "system" fn Java_finance_satori_schnorrkel_SchnorrkelNative_sign
    ...
    let output = match sign(message, sk, pubkey) {
        ...
        Err(msg) => {
            ...
            env.throw_new("finance/satori/schnorrkel/SchnorrkelException", msg).unwrap();
            none
        }
    };
    output
...
#[no_mangle]
pub extern "system" fn Java_finance_satori_schnorrkel_SchnorrkelNative_verify
...
#[no_mangle]
pub extern "system" fn Java_finance_satori_schnorrkel_SchnorrkelNative_keypairFromSeed
...
#[no_mangle]
pub extern "system" fn Java_finance_satori_schnorrkel_SchnorrkelNative_deriveHard
...
#[no_mangle]
pub extern "system" fn Java_finance_satori_schnorrkel_SchnorrkelNative_deriveSoft
(env: JNIEnv, _class: JClass, keypair: jbyteArray, cc: jbyteArray) -> jbyteArray {
...
#[no_mangle]
pub extern "system" fn Java_finance_satori_schnorrkel_SchnorrkelNative_derivePublicKeySoft
