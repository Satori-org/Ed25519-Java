package finance.satori.schnorrkel;
...
public abstract class Schnorrkel {
     ...
     */
    public abstract byte[] sign(byte[] message, KeyPair keypair) throws SchnorrkelException;
     ...
     */
    public abstract boolean verify(byte[] signature, byte[] message, PublicKey publicKey) throws SchnorrkelException;
     ...
     */
    public abstract KeyPair generateKeyPair(SecureRandom random) throws SchnorrkelException;
     ...
     */
    public abstract KeyPair generateKeyPairFromSeed(byte[] seed) throws SchnorrkelException;
     ...
     */
    public abstract KeyPair deriveKeyPair(KeyPair base, ChainCode chainCode) throws SchnorrkelException;
     ...
     * @throws SchnorrkelException if Key Pair or Derivation Path are invalid
     */
    public abstract KeyPair deriveKeyPairSoft(KeyPair base, ChainCode chainCode) throws SchnorrkelException;
     ...
     */
    public abstract PublicKey derivePublicKeySoft(PublicKey base, ChainCode chainCode) throws SchnorrkelException;
